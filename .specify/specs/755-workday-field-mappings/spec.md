# Spec: 755 — Workday compensation, workFromHomeType, multi-location, country, datePosted
...
- **Country.** Fold `jobRequisitionLocation.country.alpha2Code` into
  `LocationDto.country` via the zero-dep `regionNameFromCode` helper (Spec 752),
