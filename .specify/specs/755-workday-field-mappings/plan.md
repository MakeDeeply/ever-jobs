# Plan: 755 — Workday compensation, workFromHomeType, multi-location, country, datePosted
...
- **`Intl.DisplayNames` locale drift.** Confined to the single
  `regionNameFromCode` helper (Spec 752); only used to fill an otherwise-empty
  country.
