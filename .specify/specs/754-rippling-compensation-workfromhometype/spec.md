# Spec: 754 — Rippling compensation, workFromHomeType, multi-location
...
| Related specs | 744, 747, 749, 752 |

## Problem

A fresh 246-job harvest across 15 Rippling boards (gap-checked against the
`makedeeply` plugin, which already fixes descriptions via Specs 744/747)
...
- No change to description formatting (Specs 744/747 already handle it).
