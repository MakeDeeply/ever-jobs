# Plan: 743 — Source company plugin: Anatar
...
4. Map the final `JobPostDto` fields with shared type, email, and Spec 742 location helpers.
...
- Anatar locations combine geography and workplace arrangement; Spec 742 separates recognized
