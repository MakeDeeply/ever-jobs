# Spec: 743 — Source company plugin: Anatar
...
| Supersedes | (none) |
| Related specs | 001 (plugin architecture foundation), 742 (shared job-location parser) |
...
- Use the Spec 742 shared job-location parser.
...
- Use Spec 742 `parseLocationText()` rather than plugin-specific location parsing.
