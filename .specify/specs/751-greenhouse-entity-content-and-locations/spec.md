# Spec: 751 — Greenhouse entity-encoded content, locations, and metadata
...
2. **Naive location handling.** Location is read as `location.name` (or the
   ...
   with the shared `parseLocationList` helper adopted for Ashby (Spec 749).
