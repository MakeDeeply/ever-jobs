...
- [x] T04 — Add `bad_input` `SourceDiagnosticDto` rows for unresolved `companyDomain` values when the request proceeds
...
- [ ] T10 — Commit, push `devin/5095-jobs-service-companydomain-routing`, and open PR to `develop`
