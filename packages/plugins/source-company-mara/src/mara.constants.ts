 ...
 */
export const MARA_COMPANY_NAME = 'Mara Defense';
export const MARA_ORIGIN = 'https://mara.inc';
export const MARA_CAREERS_URL = `${MARA_ORIGIN}/career`;

/** Webflow card selectors (stable, human-authored class names). */
export const MARA_CARD_SELECTOR = '.mr-job-content-box';
export const MARA_TITLE_SELECTOR = '.mr-h4';
export const MARA_HIGHLIGHT_SELECTOR = '.label-transparant';
export const MARA_LABEL_SELECTOR = '.label-location';
export const MARA_APPLY_SELECTOR = 'a[href*="linkedin.com/jobs"]';

export const MARA_DEFAULT_RESULTS = 50;
export const MARA_DEFAULT_TIMEOUT_SECONDS = 20;
