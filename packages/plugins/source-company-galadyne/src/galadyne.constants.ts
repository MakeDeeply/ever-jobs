...
export const GALADYNE_COMPANY_NAME = 'Galadyne';

/** Site origin. */
export const GALADYNE_ORIGIN = 'https://www.galadyne.io';

/** Public careers page (used as companyUrl, jobUrl, and applyUrl). */
export const GALADYNE_CAREERS_URL = `${GALADYNE_ORIGIN}/careers`;
 ...
 */
export const GALADYNE_CHUNK_HREF_RE =
  /\/_next\/static\/chunks\/app\/careers\/page-[^"'\\]+?\.js(?:\?[^"'\\]*)?/;

/** Default number of roles returned when the caller does not specify. */
export const GALADYNE_DEFAULT_RESULTS = 50;

/** Default per-request timeout (seconds). */
export const GALADYNE_DEFAULT_TIMEOUT_SECONDS = 30;
