...
export const VIGHT_COMPANY_NAME = 'Vight';

/** Site origin. */
export const VIGHT_ORIGIN = 'https://vightaero.com';

/** Public careers page — also the listing fetch target (companyUrl). */
export const VIGHT_CAREERS_URL = `${VIGHT_ORIGIN}/join-us/`;

/** Path fragment that marks a Cloudflare email-protected apply link. */
export const VIGHT_CF_EMAIL_PATH = '/cdn-cgi/l/email-protection';

/** Default number of roles returned when the caller does not specify. */
export const VIGHT_DEFAULT_RESULTS = 50;

/** Default per-request timeout (seconds). */
export const VIGHT_DEFAULT_TIMEOUT_SECONDS = 20;
