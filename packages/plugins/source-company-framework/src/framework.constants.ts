 ...
 *      {@link FRAMEWORK_JD_SECTION_NAMES}).
 *
...
export const FRAMEWORK_COMPANY_NAME = 'Framework Automation';

/** Site origin. */
export const FRAMEWORK_ORIGIN = 'https://framework.co';

/** Public careers landing page — also the listing fetch target (companyUrl). */
export const FRAMEWORK_CAREERS_URL = `${FRAMEWORK_ORIGIN}/hiring`;

/** Shared on-domain application form (applyUrl); no per-role apply URL exists. */
export const FRAMEWORK_APPLY_URL = `${FRAMEWORK_ORIGIN}/apply`;

/** Path prefix that identifies a role detail page. */
export const FRAMEWORK_ROLE_PATH = '/jobs/';
 ...
 */
export const FRAMEWORK_JD_SECTION_NAMES: readonly string[] = [
  'Who we are',
  'Life at Frameworks',
  'Requirements',
];
...
export const FRAMEWORK_LOCATION_FRAMER_NAME = 'Location';

/** Framer `data-framer-name` of the container holding the `Salary:` value. */
export const FRAMEWORK_SALARY_FRAMER_NAME = 'Salary';

/** Default number of roles returned when the caller does not specify. */
export const FRAMEWORK_DEFAULT_RESULTS = 50;

/** Default per-request timeout (seconds). */
export const FRAMEWORK_DEFAULT_TIMEOUT_SECONDS = 20;
